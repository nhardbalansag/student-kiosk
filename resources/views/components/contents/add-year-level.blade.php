    ...
    <section class="content">
        ...
        <div class="d-flex justify-content-center">
            <div class="card card-primary">
                ...
                <form action={{ route('admin.submit-year-level') }} method="post">
                    @csrf
                    <div class="card-body">
                        <div class="form-group">
                            <label for="exampleInputPassword1">Year Level Title</label>
                            <input name="year_title" type="text" class="form-control" id="exampleInputPassword1">
                        </div>
                        <div class="form-group">
